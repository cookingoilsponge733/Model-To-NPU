...
- **0.2.0** — thermal logging, `sustained_high_performance`, HTP backend extensions: **79.7–80.6 s total**.
- **0.1.3** — QNN `mmap`, **104.4 s total**.
- **0.1.2** — live preview (TAESD), ½-CFG toggle.
